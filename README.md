<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=rect&color=0:2C3E50,100:34495E&height=120&section=header&text=Thiago%20Cardoso&fontSize=40&fontColor=ffffff&animation=fadeIn&fontAlignY=60&desc=Estagiário%20DevSecOps%20%7C%20Futuro%20Arquiteto%20de%20Soluções&descAlignY=80&descSize=16"/>
</div>

<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Inter&weight=300&size=26&duration=4000&pause=2000&color=4ECDC4&center=true&vCenter=true&width=900&lines=Transformando+Ideias+em+Soluções+Tecnológicas;Construindo+o+Futuro+da+Nuvem+e+Segurança;Inovação+Através+de+Dados+e+Automação;DevSecOps:+Integração+de+Desenvolvimento+e+Segurança;Arquitetura+Escalável+para+Negócios+Inovadores;Sempre+Evoluindo+com+Tecnologia" alt="Foco Profissional" />
</div>
...
**Thiago Cardoso** | *Estagiário DevSecOps & Futuro Arquiteto de Soluções em Nuvem*

**Posição Atual**: Estagiário DevSecOps na **Compass UOL**  
**Formação Superior**: Big Data para Negócios na **FATEC**  
**Formação Técnica**: Marketing na **ETEC**

### **Competências Principais**
- **Computação em Nuvem**: AWS, Google Cloud
- **DevSecOps**: Automação de Segurança & Melhores Práticas  
- **Engenharia de Dados**: Analytics & Desenvolvimento de Pipelines
- **Infraestrutura**: Pipelines CI/CD & Infraestrutura como Código
- **Segurança**: Implementação Abrangente de Segurança

</td>
<td width="35%">
<div align="center">
  <br/>
  <img src="https://media.licdn.com/dms/image/v2/D5603AQF9QulJFUoKdw/profile-displayphoto-crop_800_800/B56ZkdcTSfIAAI-/0/1757135582996?e=1761782400&v=beta&t=AoQSn4Q86y3KCLldPUONmb9XHJHkq05M6FEzVo01-2g" width="200" alt="Thiago Cardoso" style="border-radius: 50%; border: 3px solid #34495E;"/>
  
  <br/><br/>
  
  <img src="https://readme-typing-svg.herokuapp.com?font=JetBrains+Mono&size=14&duration=4000&pause=2000&color=4ECDC4&center=true&vCenter=true&width=350&lines=while+aprendendo:+crescer();+if+desafios:+superar();+try:+persistir();+except+Fracasso:+aprender();+futuro+%3D+await+conquistar();+print('Sempre+evoluindo...');+while+True:+inovar();+def+sucesso():+return+'inevit%C3%A1vel';" alt="Assinatura de Código" />
...
<img src="https://readme-typing-svg.herokuapp.com?font=Inter&weight=300&size=20&duration=3000&pause=1000&color=4ECDC4&center=true&vCenter=true&width=600&lines=Obrigado+pela+visita!;Construindo+o+futuro+da+tecnologia;Sempre+aberto+para+colaborações" alt="Closing Message" />
...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=rect&color=0:2C3E50,100:34495E&height=80&section=footer&animation=fadeIn"/>
</div>
